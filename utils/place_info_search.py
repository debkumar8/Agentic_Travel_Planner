...
class GooglePlaceSearchTool:
    def __init__(self, api_key: str):
        ...
        # entire real time information i can get from "gplaces_api_key", which is providing by google itself, couple of request is free over there
        
        self.places_tool = GooglePlacesTool(api_wrapper=self.places_wrapper)
    
    def google_search_attractions(self, place: str) -> dict:    # it will provide top attractive place
        """
    ...
    def google_search_restaurants(self, place: str) -> dict:      # it will provide top attractive restaurants
        """
    ...
    def google_search_activity(self, place: str) -> dict: # it will provide top activity of the specific city
        """
    ...
    def google_search_transportation(self, place: str) -> dict:   # it will provide transportation based on the provided city
        """
...
class TavilyPlaceSearchTool: # Scrap the information from the internet
    def __init__(self):
        pass
