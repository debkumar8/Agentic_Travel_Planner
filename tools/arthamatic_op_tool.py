...
from langchain_community.utilities.alpha_vantage import AlphaVantageAPIWrapper # we are using it for the "currency_converter"
# as dollar to rupees and rupees to dollar
